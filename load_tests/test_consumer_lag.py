...
from utils import setup_logger, get_consumer_lag, stop_container, start_container, get_docker_client
import threading
import signal
...
def test_consumer_lag(stop_time=60, recovery_time=120):
    ...
    fig.update_layout(title='Consumer Lag Recovery', xaxis_title='Recovery Time (s)', yaxis_title='Lag', template='plotly_white')
